...
public class PlantWateringService extends IntentService {
    ...
    // TODO COMPLETED (3): Create a new action ACTION_UPDATE_PLANT_WIDGETS to handle updating widget UI and
    ...
    public static void startActionWaterPlants(Context context) {
        Log.v(LOG_TAG, "-> startActionWaterPlants");
    ...
    public static void startActionUpdatePlantWidgets(Context context) {
        Log.v(LOG_TAG, "-> startActionUpdatePlantWidgets");
    ...
    private void handleActionWaterPlants() {
        Log.v(LOG_TAG, "-> handleActionWaterPlants");
    ...
    private void handleActionUpdatePlantWidgets() {
        Log.v(LOG_TAG, "-> handleActionUpdatePlantWidgets");
